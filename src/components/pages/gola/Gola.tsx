  ...
  return (
    <BaseUI title={title} description={description}>
      ...
      <div className={styles.container}>
        ...
        <Visible visible={!isLoading} style={{ height: '100%' }}>
...
const StyledCard = styled.div<{ satisfaction: string; grade: number }>`
  &&::after {
    content: '';
    width: 100%;
    background: ${({ satisfaction }) => `rgb(var(--gola-${satisfaction}-rgb))`};
    height: 100%;
    position: absolute;
    top: 0;
    z-index: 99999;
